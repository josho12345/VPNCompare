...
const vpns = [
  ...
  { id:'hideme', name:'hide.me', speed:null, speedLabel:'PENDING TEST', servers:'2,600+', nolog:true, kill:true, devices:10, monthly:11.99, annual:4.99, biennial:2.69, score:null, tags:['personal','privacy'], tagLabel:'', tagClass:'', card:false, highlight:false, live:false, tagline:'', features:['Independently audited no-logs (Securitum, 2024)','Malaysia jurisdiction -- outside 5/9/14-eyes','Multihop double-server routing','Dynamic port forwarding','10 simultaneous devices','Free tier available (no card required)'], link:'https://hide.me/?friend=6a5f330047e0e', guarantee:'30-day money-back', origPrice:11.99,
...
function renderDeals(){
  ...
  deals.forEach(d=>{
    ...
    card.innerHTML=`
      ...
      <p class="deal-terms">Price verified 19 July 2026 · Confirm at provider website before purchase</p>`;
    g.appendChild(card);
  });
}
