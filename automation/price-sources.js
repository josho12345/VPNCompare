...
const PRICE_SOURCES = {
  ...
  cyberghost: { name: 'CyberGhost',             pricingUrl: 'https://www.cyberghostvpn.com/en_US/buy.html',      domain: 'cyberghostvpn.com' },
  ...
  perimeter:  { name: 'Perimeter 81',           pricingUrl: 'https://www.perimeter81.com/pricing',               domain: 'perimeter81.com' },      // UNVERIFIED — may have rebranded under Check Point
  ...
  pia:        { name: 'Private Internet Access',pricingUrl: 'https://www.privateinternetaccess.com/pricing',     domain: 'privateinternetaccess.com' }, // UNVERIFIED
  windscribe: { name: 'Windscribe',             pricingUrl: 'https://windscribe.com/pricing',                    domain: 'windscribe.com' },       // UNVERIFIED
  hidemyass:  { name: 'HideMyAss',              pricingUrl: 'https://www.hidemyass.com/en-gb/prices',            domain: 'hidemyass.com' },        // UNVERIFIED
};
