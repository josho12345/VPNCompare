...
const vpns = [
  ...
  { id:'hideme', name:'hide.me', speed:null, speedLabel:'PENDING TEST', servers:'2,600+', nolog:true, kill:true, devices:10, monthly:11.99, annual:4.99, biennial:2.69, score:null, tags:['personal','privacy'], tagLabel:'', tagClass:'', card:false, highlight:false, live:false, tagline:'', features:['Independently audited no-logs (Securitum, 2024)','Malaysia jurisdiction -- outside 5/9/14-eyes','Multihop double-server routing','Dynamic port forwarding','10 simultaneous devices','Free tier available (no card required)'], link:'PENDING', guarantee:'30-day money-back', origPrice:11.99,
